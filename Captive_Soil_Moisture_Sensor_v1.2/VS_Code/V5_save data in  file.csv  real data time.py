...
with open('soil_moisture_data.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Date', 'Time', 'Time (s)', 'Soil Moisture (%)'])  # Write header
        ...
        while True:
            ...
            if ser.in_waiting > 0:
                try:
                    ...
                    # Log data to CSV
                    writer.writerow([date, current_time_formatted, current_time, soil_moisture_percentage])
